<template>
  <div id="china_map" style="width:100%;height:98%;"></div>
</template>
...
export default {
  ...
  methods:{
    drawFlowMap() {
      var queryAssetChart = this.$echarts.init(document.getElementById('china_map'));
...
//  console.log(mapFeatures)
      ...
      // 使用刚指定的配置项和数据显示图表。
      queryAssetChart.setOption(mapChartOption);
    }
  }
}
</script>
